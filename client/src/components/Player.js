...
function Player() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 p-5 shadow-lg bg-white">
      <div className="flex justify-between items-center border p-5 border-green-700 rounded shadow-xl">
        <div className="flex items-center gap-2 w-96">
          <img
            className="h-30 w-32"
            src="https://thumbs.dreamstime.com/b/headphone-logo-design-template-headphone-logo-design-template-115058304.jpg"
            alt=""
          />
          <div>
